/* $Id: session.h 13 2011-04-20 15:41:43Z mmamonski $ */
/*
...
fsd_drmaa_jsession_t *
fsd_drmaa_jsession_new( const char *contact );
...
/** DRMAA JobSession data. */
struct fsd_drmaa_jsession_s {
	drmaa2_string (*get_contact)(fsd_drmaa_jsession_t *self);

	drmaa2_string (*get_session_name)(fsd_drmaa_jsession_t *self);

	drmaa2_string_list (*get_job_categories)(fsd_drmaa_jsession_t *self);

	drmaa2_j_list (*get_jobs)(fsd_drmaa_jsession_t *self);

	drmaa2_jarray (*get_job_array)(fsd_drmaa_jsession_t *self);

	drmaa2_j (*run_job)(fsd_drmaa_jsession_t *self);

	drmaa2_jarray (*run_bulk_jobs)(fsd_drmaa_jsession_t *self);

	drmaa2_j (*wait_any_started)(fsd_drmaa_jsession_t *self, const drmaa2_j_list l, const time_t timeout);

	drmaa2_j (*wait_any_terminated)(fsd_drmaa_jsession_t *self, const drmaa2_j_list l, const time_t timeout);


	void (*destroy)(fsd_drmaa_jsession_t *self);

	void (*close)(fsd_drmaa_jsession_t *self);
	 ...
	 */
	void (*
	destroy_nowait)( fsd_drmaa_jsession_t *self );


	/** Implements drmaa_run_job(). */
	char* (*
	run_job)(
			fsd_drmaa_jsession_t *self,
	 ...
	 */
	fsd_job_t* (*
	new_job)( fsd_drmaa_jsession_t *self, const char *job_id );
	...
	void* (*
	wait_thread)( fsd_drmaa_jsession_t *self );

	void (*
	stop_wait_thread)( fsd_drmaa_jsession_t *self );

	/**
	 * Make status of all jobs held in session up to date.
	 */
	void (*
	update_all_jobs_status)( fsd_drmaa_jsession_t *self );
	...
	fsd_job_t* (*
	get_job)(
			fsd_drmaa_jsession_t *self, const char *job_id
			);
	...
	void (*
	load_configuration)(
			fsd_drmaa_jsession_t *self, const char *basename
			);
